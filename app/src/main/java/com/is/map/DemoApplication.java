...
import com.is.map.bdapi.LBSLocation;
import com.is.map.bdapi.LBSMapActivity;
...
public class DemoApplication extends Application {
	...
	// 用于更新检索结果后，刷新列表
	private LBSListActivity.ContentAdapter adapter;
	...
	public LBSListActivity.ContentAdapter getAdapter() {
		return adapter;
	}

	public void setAdapter(LBSListActivity.ContentAdapter adapter) {
