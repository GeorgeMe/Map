...
import com.is.map.bdapi.LBSCloudSearch;
...
public class MainActivity extends TabActivity {
	...
	private void initRadioGroup() {
		...
		// 附近搜索 选择不同距离的点击事件
		filter2.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
			@Override
...
//					int leasetype = jsonObject3.getInt("leasetype");
		...
		LBSListActivity.ContentAdapter adapter = ((DemoApplication) getApplication())
				.getAdapter();
		if (adapter != null) {
